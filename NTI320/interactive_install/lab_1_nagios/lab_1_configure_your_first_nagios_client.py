...
if __name__ == "__main__":
    ...
    internal_ip = raw_input("Enter the internal ip address of your nagios-a server: ")
    os.system('sed -i "s/allowed_hosts=127.0.0.1/allowed_hosts=127.0.0.1, '
              + internal_ip + '/g" /etc/nagios/nrpe.cfg')
